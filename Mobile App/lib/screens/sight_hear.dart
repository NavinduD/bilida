...
class SightHear extends StatefulWidget {
  const SightHear({Key? key}) : super(key: key);

  @override
  State<SightHear> createState() => _RemindMeState();
}

class _RemindMeState extends State<SightHear> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: const Color.fromRGBO(242, 187, 124, 20),
          leading: IconButton(
            icon: const Icon(
